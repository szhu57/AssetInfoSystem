...
<!-- 				<li class="click" id="delclick"><span><img src="images/t03.png" /></span>删除</li> -->
				<li class="click" id="mortgageclick"><span><img src="images/t04.png" /></span>待审批业务</li>
			</ul>
			...
			<tbody>
				<c:forEach var="asset" items="${assets}" varStatus="status">
					<tr>
						...
						<td>${asset.usedate}</td>
						<td>已审核</td>
						<td><a href="approval?status=3&assetno=${asset.no}" class="tablelink">通过</a> <a href="approval?status=1&assetno=${asset.no}" class="tablelink">不通过</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
