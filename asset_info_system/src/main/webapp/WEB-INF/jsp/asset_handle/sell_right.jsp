...
<!-- 				<li class="click" id="delclick"><span><img src="images/t03.png" /></span>删除</li> -->
				<li class="click" id="mortgageclick"><span><img src="images/t04.png" /></span>出售</li>
			</ul>
			...
			<tbody>
				<c:forEach var="asset" items="${assets}" varStatus="status">
					<tr>
						...
						<td>${asset.usedate}</td>
						<td>已审核</td>
						<td><a href="asset_handle?status=5&ways=sell&assetno=${asset.no}" class="tablelink">出售</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
