		...
		<table class="tablelist">
			<thead>
				<tr>
					...
					<th>资产大类<i class="sort"><img src="images/px.gif" /></i></th>
					<th>详细类别</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="assetType" items="${assetTypes}" varStatus="status">
					<tr>
						<td><input name="assettypechecked" class="checkbox" type="checkbox" value="${assetType.id}" /></td>
						<td>${assetType.type}</td>
						<td>${assetType.subType}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
